...
window.__CONSISTENT_CART_SETTINGS = {
	'last_updated':"2016-11-27 18:18:28 +0000",
	'testing':'this',
};
...
},{"./constants":4,"./storage":7,"jquery":2}],7:[function(require,module,exports){
...
},{"jquery":2,"js-cookie":3}],8:[function(require,module,exports){
...
},{"./constants":4,"./logger":6,"./storage":7,"jquery":2}],9:[function(require,module,exports){
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var a=r[t];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(r,t,a){return t&&e(r.prototype,t),a&&e(r,a),r}}(),_jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery),_storage=require("./storage"),_storage2=_interopRequireDefault(_storage),_user=require("./user"),_user2=_interopRequireDefault(_user),_logger=require("./logger"),_logger2=_interopRequireDefault(_logger),_utility=require("./utility"),_utility2=_interopRequireDefault(_utility),storage=new _storage2["default"],user=new _user2["default"],logger=new _logger2["default"],utility=new _utility2["default"],AjaxInterceptor=require("ajax-interceptor"),Watcher=function(){function e(r){_classCallCheck(this,e),this.user=user,Shopify.merge_cart_text&&Shopify.merge_cart_text.indexOf("translation missing:")<0?this.mergeCartText=Shopify.merge_cart_text:this.mergeCartText="It seems you already have a cart from a previous session. Would you like to merge your previous cart with your current cart?"}return _createClass(e,[{key:"replicateServerCartIfNewer",value:function(){var e=arguments.length<=0||void 0===arguments[0]?!1:arguments[0],r=this,t={shopify_domain:storage.get("shop"),email:Shopify.customer_email},a=0;_jquery2["default"].ajax({url:"https://consistentcart.herokuapp.com/get_cart",type:"GET",dataType:"json",data:t,async:e,success:function(e,t,o){logger.log("got the cart from the server REPLICATE"),"undefined"==typeof o.responseJSON&&(o.responseJSON=JSON.parse(o.responseText)),a=o.responseJSON.number,a>storage.get("number")&&r.mergeTheShoppingCarts(!0)}})}},{key:"mergeTheShoppingCarts",value:function(){var e=arguments.length<=0||void 0===arguments[0]?!1:arguments[0],r=this,t={shopify_domain:storage.get("shop"),email:Shopify.customer_email};_jquery2["default"].ajax({url:"https://consistentcart.herokuapp.com/get_cart",type:"GET",dataType:"json",data:t,async:!1,success:function(t,a,o){if(logger.log("got the cart from the server"),"undefined"==typeof o.responseJSON&&(o.responseJSON=JSON.parse(o.responseText)),storage.set("number",o.responseJSON.number),null!=o.responseJSON){var s=null;if(_jquery2["default"].ajax({url:"/cart.js",type:"GET",dataType:"json",async:!1,success:function(e,r,t){logger.log("success"),"undefined"==typeof t.responseJSON&&(t.responseJSON=JSON.parse(t.responseText)),s=utility.itemArrayTrimmer(t.responseJSON.items)}}),0==s.length&&0==Object.keys(o.responseJSON.items).length)return!0;if(e&&(_jquery2["default"].ajax({url:"/cart/clear.js",type:"POST",dataType:"json",async:!1,success:function(e,r,t){logger.log("cleared the cart")}}),s=[]),JSON.stringify(s)!=JSON.stringify(o.responseJSON.items)){var n=!1;if(0==s.length)n=!0;else{var i=!0;for(var u in o.responseJSON.items)if(o.responseJSON.items.hasOwnProperty(u)){var g=o.responseJSON.items[u],l=!1;for(var c in s)if(s.hasOwnProperty(c)){var p=s[c];if(p.variant_id==g.variant_id){l=!0;break}}if(!l){i=!1;break}}n=i?!1:e?!0:confirm(r.mergeCartText)}if(n){var f=Object.keys(o.responseJSON.items).reverse();for(var u in f)if(f.hasOwnProperty(u)){var g=o.responseJSON.items[u],y={id:g.variant_id,quantity:g.quantity},m=!0;for(var c in s)if(s.hasOwnProperty(c)){var p=s[c];p.variant_id==g.variant_id&&(m=!1)}m&&r.user.addToCart(y)}setTimeout(function(){window.location.href=window.location.href},3e3)}}}}})}},{key:"updateCartOnServer",value:function(e){logger.log("UC1: called updateCartOnServer");var r={shopify_domain:storage.get("shop"),email:Shopify.customer_email,cart:e};logger.log("UC2: here is xhrjson"),logger.log(e),_jquery2["default"].post("https://consistentcart.herokuapp.com/set_cart",r,function(e){logger.log("UC3: post set_cart"),storage.set("number",e.number),logger.log("UC4: set cart number")})}},{key:"getCartPolling",value:function(){var e=this;e.getCart(!0);var r=["/cart/add.js","/cart/update.js","/cart/change.js","/cart/clear.js"];AjaxInterceptor.addRequestCallback(function(t){r.indexOf(t._url)>-1&&setTimeout(function(){e.getCart(!0)},1e3)}),AjaxInterceptor.wire(),window.ccCartPoller=window.ccCartPoller||setInterval(function(){e.getCart(!0)},3e4)}},{key:"getCart",value:function(){var e=arguments.length<=0||void 0===arguments[0]?!1:arguments[0];logger.log("GC1: called getCart");var r=this;if(window.emergencyStopPolling)return!1;var t=storage.get("ccCartItems");return t&&!e?(logger.log("GC2: returning the current cart"),t):(logger.log("GC3: getting shopify cart"),_jquery2["default"].ajax({url:"/cart.js",type:"GET",dataType:"json",async:e,success:function(e,t,a){logger.log("success"),"undefined"==typeof a.responseJSON&&(a.responseJSON=JSON.parse(a.responseText)),logger.log("GC4: got the shopify cart"),JSON.stringify(storage.get("ccCartItems"))!=JSON.stringify(utility.itemArrayTrimmer(a.responseJSON.items))&&(logger.log("GC5: the storage cart is different than the shopify cart, so updating server"),r.updateCartOnServer(utility.itemArrayTrimmer(a.responseJSON.items))),logger.log("GC6: setting the storage cart again"),storage.set("ccCartItems",utility.itemArrayTrimmer(a.responseJSON.items))},error:function(e,r,t){window.emergencyErrorCount=window.emergencyErrorCount||0,window.emergencyErrorCount+=1,window.emergencyErrorCount>3&&(window.emergencyStopPolling=!0)}}))}}]),e}();exports["default"]=Watcher,module.exports=exports["default"];

},{"./logger":6,"./storage":7,"./user":8,"./utility":9,"ajax-interceptor":1,"jquery":2}]},{},[5]);
